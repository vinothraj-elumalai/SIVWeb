...
--
-- Name: admissionplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE admissionplayschool (
    applno character varying(255) NOT NULL,
    academicyear character varying(255),
    admissiondate timestamp without time zone,
    admissionfor character varying(255),
    admissionstatus character varying(255),
    loginuser character varying(255),
...
ALTER TABLE admissionplayschool OWNER TO postgres;
...
--
-- Name: applicationsaleplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE applicationsaleplayschool (
    applno character varying(255) NOT NULL,
    academicyear character varying(255),
    age bigint,
    appfor character varying(255),
    ...
    fathersaltmobno character varying(255),
    fathersemail character varying(255),
    fathersmobileno character varying(255),
    followupdate timestamp without time zone,
    gender character varying(255),
    loginuser character varying(255),
    mothersaltmobno character varying(255),
    mothersemail character varying(255),
    mothersmobileno character varying(255),
    presentaddress1 character varying(255),
    presentaddress2 character varying(255),
    presentarea character varying(255),
    presentpincode character varying(255),
...
ALTER TABLE applicationsaleplayschool OWNER TO postgres;

--
-- Name: applicationsales; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE applicationsales (
    applno character varying(255) NOT NULL,
    appfor character varying(255) NOT NULL,
    applicationpaidmode character varying(255) NOT NULL,
    applicationprice integer NOT NULL,
    candfathername character varying(255) NOT NULL,
    candfirstname character varying(255) NOT NULL,
    candlastname character varying(255) NOT NULL,
    candmiddlename character varying(255) NOT NULL,
    candmothername character varying(255) NOT NULL,
    category character varying(255) NOT NULL,
    followupdate timestamp without time zone NOT NULL,
    gender character varying(255) NOT NULL,
    loginuser character varying(255) NOT NULL,
    peramanentpincode character varying(255) NOT NULL,
    permanentaddress1 character varying(255) NOT NULL,
    permanentaddress2 character varying(255) NOT NULL,
    permanentaltemail character varying(255) NOT NULL,
    permanentaltmobno character varying(255) NOT NULL,
    permanentarea character varying(255) NOT NULL,
    permanentemail character varying(255) NOT NULL,
    permanentmobileno character varying(255) NOT NULL,
    permanentstate character varying(255) NOT NULL,
    prefferedcour1 character varying(255) NOT NULL,
    prefferedcour2 character varying(255) NOT NULL,
    prefferedcour3 character varying(255) NOT NULL,
    presentaddress1 character varying(255) NOT NULL,
    presentaddress2 character varying(255) NOT NULL,
    presentaltemail character varying(255) NOT NULL,
    presentaltmobno character varying(255) NOT NULL,
    presentarea character varying(255) NOT NULL,
    presentemail character varying(255) NOT NULL,
    presentmobileno character varying(255) NOT NULL,
    presentpincode character varying(255) NOT NULL,
    presentstate character varying(255) NOT NULL,
    ...
    willingtojoin character varying(255) NOT NULL,
    application_no character varying(255)
);


ALTER TABLE applicationsales OWNER TO postgres;
...
--
-- Name: childspickupplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE childspickupplayschool (
    pickupid character varying(255) NOT NULL,
    academicyear character varying(255),
    loginuser character varying(255),
    name character varying(255),
    pickup_person_mobileno character varying(255),
    pickup_person_name character varying(255),
    pickup_person_relation character varying(255),
    pickupday character varying(255),
    pickupddate timestamp without time zone,
    pickuptime character varying(255),
...
ALTER TABLE childspickupplayschool OWNER TO postgres;
...
--
-- Name: emergencymessageplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE emergencymessageplayschool (
    emergencymessageid character varying(255) NOT NULL,
    academicyear character varying(255),
...
ALTER TABLE emergencymessageplayschool OWNER TO postgres;
...
--
-- Name: eventscircularsplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE eventscircularsplayschool (
    eventid character varying(255) NOT NULL,
    academicyear character varying(255),
    entrydate timestamp without time zone,
    eventdate timestamp without time zone,
    eventday character varying(255),
    loginuser character varying(255),
    message character varying(255),
    program character varying(255),
    section character varying(255)
...
ALTER TABLE eventscircularsplayschool OWNER TO postgres;
...
--
-- Name: feespaymentplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE feespaymentplayschool (
    billno character varying(255) NOT NULL,
    academicyear character varying(255),
    balance bigint,
    bankname character varying(255),
    ...
    registernumber character varying(255),
    school_fees bigint,
    school_fees_paid bigint,
    school_fees_title character varying(255),
    section character varying(255),
    total_fees_paid bigint,
    totalfees bigint,
    transport_fees bigint,
    transport_fees_paid bigint,
    transport_fees_title character varying(255)
);


ALTER TABLE feespaymentplayschool OWNER TO postgres;
...
--
-- Name: firsttable; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE firsttable OWNER TO postgres;
...
--
-- Name: playschoolbalancefeestable; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschoolbalancefeestable (
    registernumber character varying(255) NOT NULL,
    academicyear character varying(255),
    admission_fees_due_date timestamp without time zone,
    admissionfees bigint,
    grand_total_fees bigint,
    loginuser character varying(255),
    term1_fees_due_date timestamp without time zone,
    term1fees bigint,
    term1transportfees bigint,
    term2_fees_due_date timestamp without time zone,
    term2fees bigint,
    term2transportfees bigint,
    total_admission_fees bigint,
    total_term1_fees bigint,
    total_term2_fees bigint,
    transportfees bigint,
    student_base_registernumber character varying(255) NOT NULL
);


ALTER TABLE playschoolbalancefeestable OWNER TO postgres;

--
-- Name: playschoolfeesentrybase; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschoolfeesentrybase (
    registernumber character varying(255) NOT NULL,
    academicyear character varying(255),
    admissionfees bigint,
    grand_total_fees bigint,
...
ALTER TABLE playschoolfeesentrybase OWNER TO postgres;

--
-- Name: playschoolschoolfeessetting; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschoolschoolfeessetting (
    academicyear character varying(255) NOT NULL,
    program character varying(255) NOT NULL,
    admissionfees bigint,
    admissionfees_due_date timestamp without time zone,
    fees_setting_date timestamp without time zone,
    grandtotalfees bigint,
    loginuser character varying(255),
    term1fees bigint,
    term1fees_due_date timestamp without time zone,
    term2fees bigint,
    term2fees_due_date timestamp without time zone
);


ALTER TABLE playschoolschoolfeessetting OWNER TO postgres;

--
-- Name: playschoolstudentbaseinformation; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschoolstudentbaseinformation (
    registernumber character varying(255) NOT NULL,
    academicyear character varying(255),
    candidatename character varying(255),
    loginuser character varying(255),
    section character varying(255),
    standardstudying character varying(255),
    studentstatus character varying(255),
    student_base_registernumber character varying(255) NOT NULL
);


ALTER TABLE playschoolstudentbaseinformation OWNER TO postgres;

--
-- Name: playschoolstudentpersonalinformation; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschoolstudentpersonalinformation (
    registernumber character varying(255) NOT NULL,
    academicyear character varying(255),
    age bigint,
    candfathername character varying(255),
    ...
    dateofbirth timestamp without time zone,
    fathersaltmobno character varying(255),
    fathersdob timestamp without time zone,
    fathersemail character varying(255),
    fathersmobileno character varying(255),
    fathersoccupation character varying(255),
    fathersofficeaddress1 character varying(255),
    fathersofficeaddress2 character varying(255),
    fathersofficealtphoneno character varying(255),
    fathersofficearea character varying(255),
    fathersofficeextensionno character varying(255),
    fathersofficename character varying(255),
    fathersofficephoneno character varying(255),
    fathersofficepincode character varying(255),
    fathersofficestate character varying(255),
    gender character varying(255),
    loginuser character varying(255),
    mothersaltmobno character varying(255),
    mothersdob timestamp without time zone,
    mothersemail character varying(255),
    mothersmobileno character varying(255),
    mothersoccupation character varying(255),
    mothersofficeaddress1 character varying(255),
    mothersofficeaddress2 character varying(255),
    mothersofficealtphoneno character varying(255),
    mothersofficearea character varying(255),
    mothersofficeextensionno character varying(255),
    mothersofficename character varying(255),
    mothersofficephoneno character varying(255),
    mothersofficepincode character varying(255),
    mothersofficestate character varying(255),
    parentsweddingdate timestamp without time zone,
    pickuppersonaltcontactno character varying(255),
    pickuppersoncontactno character varying(255),
    pickuppersonname character varying(255),
    pickuppersonrelationship character varying(255),
    presentaddress1 character varying(255),
    presentaddress2 character varying(255),
    presentarea character varying(255),
    presentpincode character varying(255),
...
ALTER TABLE playschoolstudentpersonalinformation OWNER TO postgres;

--
-- Name: playschooltransportsetting; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE playschooltransportsetting (
    academicyear character varying(255) NOT NULL,
    stage character varying(255) NOT NULL,
    fees_setting_date timestamp without time zone,
    loginuser character varying(255),
    transport_initial_fees bigint,
    transport_term1_fees bigint,
    transport_term2_fees bigint
);


ALTER TABLE playschooltransportsetting OWNER TO postgres;
...
CREATE TABLE securityvisitorpass (
    ...
    persontomeet character varying(255) NOT NULL,
    reason character varying(255) NOT NULL,
    semester integer NOT NULL,
    staffid character varying(255) NOT NULL,
    timein character varying(255) NOT NULL,
    ...
    visitortransportmode character varying(255) NOT NULL
);
...
--
-- Name: staffpersonalinformationplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE staffpersonalinformationplayschool (
    staffid character varying(255) NOT NULL,
    addressline1 character varying(255),
    addressline2 character varying(255),
    age integer,
    alternativemobilenumber character varying(255),
    area character varying(255),
    bloodgroup character varying(255),
    course character varying(255),
    date_of_join timestamp without time zone,
    dateofbirth timestamp without time zone,
    designation character varying(255),
    emailid character varying(255),
    experience character varying(255),
    fathersname character varying(255),
    logiuser character varying(255),
    maritalstatus character varying(255),
    mobilenumber character varying(255),
    month_year_of_pass character varying(255),
...
ALTER TABLE staffpersonalinformationplayschool OWNER TO postgres;
...
--
-- Name: studentattendancedetailplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE studentattendancedetailplayschool (
    id integer NOT NULL,
    entrydate timestamp without time zone,
    registernumber character varying(255),
    status character varying(255)
...
ALTER TABLE studentattendancedetailplayschool OWNER TO postgres;
...
--
-- Name: studentattendanceheaderplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE studentattendanceheaderplayschool (
    acdemicyear character varying(255) NOT NULL,
    entrydate timestamp without time zone NOT NULL,
    program character varying(255) NOT NULL,
    section character varying(255) NOT NULL,
    entryday character varying(255),
    loginuser character varying(255),
    no_of_absent integer,
    no_of_present integer
);


ALTER TABLE studentattendanceheaderplayschool OWNER TO postgres;
...
CREATE TABLE studentfood (
    ...
    loginuser character varying(255) NOT NULL,
    semester integer NOT NULL,
    student_food_regno character varying(255) NOT NULL
);
...
--
-- Name: studenthomeworkplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE studenthomeworkplayschool (
    homeworkid character varying(255) NOT NULL,
    academicyear character varying(255),
    entrydate timestamp without time zone,
    entryday character varying(255),
    homework_content character varying(255),
    loginuser character varying(255),
    program character varying(255),
    section character varying(255),
    subjectcategory character varying(255)
);


ALTER TABLE studenthomeworkplayschool OWNER TO postgres;
...
CREATE TABLE studenthostel (
    ...
    loginuser character varying(255),
    optd_facility character varying(255),
    semester integer,
    student_hostel_regno character varying(255) NOT NULL
);
...
--
-- Name: studentsmonthlyprogressplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE studentsmonthlyprogressplayschool (
    remarkid character varying(255) NOT NULL,
    academicyear character varying(255),
    category10_rating integer,
    category1_rating integer,
    category2_rating integer,
    category3_rating integer,
    category4_rating integer,
    category5_rating integer,
    category6_rating integer,
    category7_rating integer,
    category8_rating integer,
    category9_rating integer,
    entrydate timestamp without time zone,
    entryday character varying(255),
    loginuser character varying(255),
...
ALTER TABLE studentsmonthlyprogressplayschool OWNER TO postgres;
...
--
-- Name: transportchangeplayschool; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE transportchangeplayschool (
    transportchangeid character varying(255) NOT NULL,
    academicyear character varying(255),
    entrydate timestamp without time zone,
    loginuser character varying(255),
    name character varying(255),
    ...
    section character varying(255),
    stage character varying(255),
    transport_init_fees bigint,
    transport_required character varying(255),
    transport_term1_fees bigint,
    transport_term2_fees bigint,
    transport_total_fees bigint
);


ALTER TABLE transportchangeplayschool OWNER TO postgres;
...
--
-- Data for Name: admissionplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY admissionplayschool (applno, academicyear, admissiondate, admissionfor, admissionstatus, loginuser, registernumber, section, transport, transportstage, couns_applno) FROM stdin;
101	2017-2018	2017-08-12 00:00:00	TODDLER PROGRAM	Admitted	KAMAL	TOD101	SECTION - A	PRIVATE	STAGE - I	101
102	2017-2018	2017-08-12 00:00:00	TODDLER PROGRAM	Admitted	KAMAL	TOD102	SECTION - A	PRIVATE	STAGE - I	102
103	2017-2018	2017-08-12 00:00:00	TODDLER PROGRAM	Admitted	KAMAL	TOD103	SECTION - A	SCHOOL VAN	STAGE - I	103
104	2017-2018	2017-08-12 00:00:00	LKG	Admitted	KAMAL	LKG101	SECTION - A	SCHOOL VAN	STAGE - I	104
105	2017-2018	2017-08-12 00:00:00	LKG	Admitted	KAMAL	LKG102	SECTION - A	SCHOOL VAN	STAGE - I	105
106	2017-2018	2017-08-12 00:00:00	LKG	Admitted	KAMAL	LKG103	SECTION - A	SCHOOL VAN	STAGE - I	106
\.
...
--
-- Data for Name: applicationsaleplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY applicationsaleplayschool (applno, academicyear, age, appfor, applicationpaidmode, applicationprice, candfathername, candfirstname, candlastname, candmiddlename, candmothername, category, dateofbirth, fathersaltmobno, fathersemail, fathersmobileno, followupdate, gender, loginuser, mothersaltmobno, mothersemail, mothersmobileno, presentaddress1, presentaddress2, presentarea, presentpincode, presentstate, reference, remarks, saledate, willingtojoin) FROM stdin;
101	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	akilesh	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
102	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	RAJESH	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
103	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	SURESH	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
104	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	JAI	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
105	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	MANI	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
106	2017-2018	2	TODDLER PROGRAM	Paid	200	kaisi	RAKESH	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
107	2017-2018	2	PRE-KG	Paid	200	kaisi	DINESH	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
108	2017-2018	2	PRE-KG	Paid	200	kaisi	RUPES	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
109	2017-2018	2	PRE-KG	Paid	200	kaisi	BALU	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
110	2017-2018	2	KG1	Paid	200	kaisi	BALA	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
111	2017-2018	2	KG1	Paid	200	kaisi	BALAJI	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
112	2017-2018	2	KG2	Paid	200	kaisi	ANAND	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
113	2017-2018	2	KG2	Paid	200	kaisi	ARUN	A		dfdf	Application Sale	2015-05-06 00:00:00	09283604647	informkamalakannan@gmail.com	09283604647	2017-12-12 00:00:00	Male	KAMAL	09283604647	informkamalakannan@gmail.com	09283604647	S5, II FLOOR, VASAN HOMES, BAKIALAKSHMI STREET, WEST BANU NAGAR, PUDHUR, AMBATTUR, CHENNAI	AMBATTUR	CHENNAI	600053	TamiNadu	MANIKANDAN	nil	2017-12-12 00:00:00	Yes
\.


--
-- Data for Name: applicationsales; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY applicationsales (applno, appfor, applicationpaidmode, applicationprice, candfathername, candfirstname, candlastname, candmiddlename, candmothername, category, followupdate, gender, loginuser, peramanentpincode, permanentaddress1, permanentaddress2, permanentaltemail, permanentaltmobno, permanentarea, permanentemail, permanentmobileno, permanentstate, prefferedcour1, prefferedcour2, prefferedcour3, presentaddress1, presentaddress2, presentaltemail, presentaltmobno, presentarea, presentemail, presentmobileno, presentpincode, presentstate, qualified, remarks, saledate, willingtojoin, application_no) FROM stdin;
\.
...
COPY bformheader (photoid, acadyear, allotedquota, applicationno, bcode, category, community, dob, gender, loginuser, name, qualifiedexam, religion, remarks, semester, slno, state, yearofpass) FROM stdin;
\.
...
--
-- Data for Name: childspickupplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY childspickupplayschool (pickupid, academicyear, loginuser, name, pickup_person_mobileno, pickup_person_name, pickup_person_relation, pickupday, pickupddate, pickuptime, program, registernumber, remarks, section) FROM stdin;
PCKUP001	2017-2018	\N	AKILESH	9283604647	MOHANAM	GRAND MOTHER	FRIDAY	2017-08-12 00:00:00	12.30 PM	PREKG	TOD101	9283604647	SECTION - A
PCKUP002	2017-2018	\N	SURESH	9840845757	RAJASEKAR	GRAND FATHER	FRIDAY	2017-08-12 00:00:00	12.30 PM	PREKG	TOD102	9283604647	SECTION - A
PCKUP003	2017-2018	\N	SURESHRAJ	9677288106	THANIGAVEL	GRAND FATHER	FRIDAY	2017-08-12 00:00:00	12.30 PM	PREKG	TOD103	9677288103	SECTION - A
\.
...
--
-- Data for Name: emergencymessageplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY emergencymessageplayschool (emergencymessageid, academicyear, day, entrydate, loginuser, message, name, program, registernumber, section, "time") FROM stdin;
\.
...
--
-- Data for Name: eventscircularsplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY eventscircularsplayschool (eventid, academicyear, entrydate, eventdate, eventday, loginuser, message, program, section) FROM stdin;
EVE101	2017-2018	2017-08-12 00:00:00	2017-12-12 00:00:00	FRIDAY	KAMAL	\N	TODDLER PROGRAM	SECTION - A
EVE002	2017-2018	2017-08-12 00:00:00	2018-03-12 00:00:00	FRIDAY	KAMAL	ANNUAL DAY CELEBRATION	ALL	SECTION - A
EVE003	2017-2018	2017-08-12 00:00:00	2019-01-12 00:00:00	FRIDAY	KAMAL	SPORTS DAY CELEBRATION	ALL	SECTION - A
EVE004	2017-2018	2017-08-12 00:00:00	2018-01-01 00:00:00	FRIDAY	KAMAL	NEW YEAR CELEBRATION	ALL	SECTION - A
\.
...
--
-- Data for Name: feespaymentplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY feespaymentplayschool (billno, academicyear, balance, bankname, billdate, chequedate, chequeno, duedate, loginuser, payment_method, program, registernumber, school_fees, school_fees_paid, school_fees_title, section, total_fees_paid, totalfees, transport_fees, transport_fees_paid, transport_fees_title) FROM stdin;
101	2017-2018	0	NIL	2017-07-12 00:00:00	2017-12-12 00:00:00	NIL	2017-07-12 00:00:00	\N	CASH	TODDLER PROGRAM	TOD101	30000	30000	Admission Fees	SECTION - A	40000	40000	10000	10000	Intial Fees
102	2017-2018	0	NIL	2017-08-12 00:00:00	2017-12-12 00:00:00	NIL	2017-08-12 00:00:00	\N	CASH	TODDLER PROGRAM	TOD101	10000	10000	Admission Fees	SECTION - A	15000	15000	5000	5000	Intial Fees
\.
...
--
-- Data for Name: firsttable; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY firsttable (id, name, password) FROM stdin;
0	kamal	kamal
\.
...
--
-- Data for Name: playschoolbalancefeestable; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschoolbalancefeestable (registernumber, academicyear, admission_fees_due_date, admissionfees, grand_total_fees, loginuser, term1_fees_due_date, term1fees, term1transportfees, term2_fees_due_date, term2fees, term2transportfees, total_admission_fees, total_term1_fees, total_term2_fees, transportfees, student_base_registernumber) FROM stdin;
TOD101	2017-2018	2018-05-04 00:00:00	20000	60000	KAMAL	2018-05-08 00:00:00	10000	5000	2018-05-12 00:00:00	10000	5000	35000	15000	15000	15000	TOD101
TOD102	2017-2018	2018-05-04 00:00:00	20000	35000	KAMAL	2018-05-08 00:00:00	10000	0	2018-05-12 00:00:00	10000	0	35000	15000	10000	0	TOD102
TOD103	2017-2018	2018-05-04 00:00:00	20000	65000	KAMAL	2018-05-08 00:00:00	10000	10000	2018-05-12 00:00:00	10000	10000	35000	15000	10000	10000	TOD103
LKG101	2017-2018	2018-05-04 00:00:00	20000	65000	KAMAL	2018-05-08 00:00:00	10000	10000	2018-05-12 00:00:00	10000	10000	35000	15000	10000	10000	LKG101
LKG102	2017-2018	2018-05-04 00:00:00	20000	65000	KAMAL	2018-05-08 00:00:00	10000	10000	2018-05-12 00:00:00	10000	10000	35000	15000	10000	10000	LKG102
LKG103	2017-2018	2018-05-04 00:00:00	20000	65000	KAMAL	2018-05-08 00:00:00	10000	10000	2018-05-12 00:00:00	10000	10000	35000	15000	10000	10000	LKG103
\.


--
-- Data for Name: playschoolfeesentrybase; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschoolfeesentrybase (registernumber, academicyear, admissionfees, grand_total_fees, loginuser, term1fees, term1transportfees, term2fees, term2transportfees, total_admission_fees, total_term1_fees, total_term2_fees, transportfees, student_base_registernumber) FROM stdin;
TOD101	2017-2018	20000	60000	KAMAL	10000	5000	10000	5000	35000	15000	15000	15000	TOD101
TOD102	2017-2018	20000	35000	KAMAL	10000	0	10000	0	35000	15000	10000	0	TOD102
TOD103	2017-2018	20000	65000	KAMAL	10000	10000	10000	10000	35000	15000	10000	10000	TOD103
LKG101	2017-2018	20000	65000	KAMAL	10000	10000	10000	10000	35000	15000	10000	10000	LKG101
LKG102	2017-2018	20000	65000	KAMAL	10000	10000	10000	10000	35000	15000	10000	10000	LKG102
LKG103	2017-2018	20000	65000	KAMAL	10000	10000	10000	10000	35000	15000	10000	10000	LKG103
\.


--
-- Data for Name: playschoolschoolfeessetting; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschoolschoolfeessetting (academicyear, program, admissionfees, admissionfees_due_date, fees_setting_date, grandtotalfees, loginuser, term1fees, term1fees_due_date, term2fees, term2fees_due_date) FROM stdin;
2017-2018	PRE KG	10000	2017-12-12 00:00:00	\N	30000	kamal	10000	2017-12-03 00:00:00	10000	2017-12-06 00:00:00
2017-2018	KG1	25000	2017-12-12 00:00:00	\N	75000	kamal	25000	2017-12-03 00:00:00	25000	2017-12-06 00:00:00
2017-2018	KG2	25000	2017-12-12 00:00:00	\N	75000	kamal	25000	2017-12-03 00:00:00	25000	2017-12-06 00:00:00
2017-2018	TODDLER PROGRAM	30000	2018-04-04 00:00:00	\N	60000	KAMAL	15000	2018-04-08 00:00:00	15000	2018-04-12 00:00:00
\.


--
-- Data for Name: playschoolstudentbaseinformation; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschoolstudentbaseinformation (registernumber, academicyear, candidatename, loginuser, section, standardstudying, studentstatus, student_base_registernumber) FROM stdin;
TOD101	2017-2018	AKILESH	KAMAL	SECTION - A	TODDLER PROGRAM	Admitted	TOD101
TOD102	2017-2018	RAJESH	KAMAL	SECTION - A	TODDLER PROGRAM	Admitted	TOD102
TOD103	2017-2018	SURESH	KAMAL	SECTION - A	TODDLER PROGRAM	Admitted	TOD103
LKG101	2017-2018	SURESH	KAMAL	SECTION - A	LKG	Admitted	LKG101
LKG102	2017-2018	RAMESH	KAMAL	SECTION - A	LKG	Admitted	LKG102
LKG103	2017-2018	ANAND	KAMAL	SECTION - A	LKG	Admitted	LKG103
\.


--
-- Data for Name: playschoolstudentpersonalinformation; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschoolstudentpersonalinformation (registernumber, academicyear, age, candfathername, candidatename, candmothername, dateofbirth, fathersaltmobno, fathersdob, fathersemail, fathersmobileno, fathersoccupation, fathersofficeaddress1, fathersofficeaddress2, fathersofficealtphoneno, fathersofficearea, fathersofficeextensionno, fathersofficename, fathersofficephoneno, fathersofficepincode, fathersofficestate, gender, loginuser, mothersaltmobno, mothersdob, mothersemail, mothersmobileno, mothersoccupation, mothersofficeaddress1, mothersofficeaddress2, mothersofficealtphoneno, mothersofficearea, mothersofficeextensionno, mothersofficename, mothersofficephoneno, mothersofficepincode, mothersofficestate, parentsweddingdate, pickuppersonaltcontactno, pickuppersoncontactno, pickuppersonname, pickuppersonrelationship, presentaddress1, presentaddress2, presentarea, presentpincode, presentstate, reference, religion, transport, transportstage) FROM stdin;
TOD101	2017-2018	2	NARESH	AKILESH	RADHIKA	2015-05-06 00:00:00	9283604647	1978-05-06 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-10-09 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-03-09 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	PRIVATE	STAGE - I
TOD102	2017-2018	2	SURESH	RAJESH	KEERTHIKA	2015-05-07 00:00:00	9283604647	1978-05-06 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-10-09 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-03-09 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	PRIVATE	STAGE - I
TOD103	2017-2018	2	SURESHRAJ	SURESH	KEERTHI	2015-05-08 00:00:00	9283604647	1978-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-09-12 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	SCHOOL VAN	STAGE - I
LKG101	2017-2018	2	SURESHRAJ	SURESH	KEERTHI	2015-05-08 00:00:00	9283604647	1978-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-09-12 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	SCHOOL VAN	STAGE - I
LKG102	2017-2018	2	SURESHRAJ	RAMESH	KEERTHI	2015-05-08 00:00:00	9283604647	1978-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-09-12 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	SCHOOL VAN	STAGE - I
LKG103	2017-2018	2	SURESHRAJ	ANAND	KEERTHI	2015-05-08 00:00:00	9283604647	1978-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	MALE	KAMAL	9283604647	1980-09-12 00:00:00	informkamalakannan@gmail.com	9283604647	BUSINESS	WEST BANU NAGAR	AMBATTUR	9283604647	CHENNAI	0	GB CORP	9283604647	600053	TAMILNADU	2004-09-12 00:00:00	9283604647	9283604647	MOHANAM	GRAND MOTHER	S5 VASAN HOMES BAKIALAKSHMI STREET	WEST BANU NAGAR	CHENNAI	600053	TAMILNADU	MANIKANDAN	HINDU	SCHOOL VAN	STAGE - I
\.


--
-- Data for Name: playschooltransportsetting; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY playschooltransportsetting (academicyear, stage, fees_setting_date, loginuser, transport_initial_fees, transport_term1_fees, transport_term2_fees) FROM stdin;
2017-2018	STAGE - I	2017-08-12 00:00:00	KAMAL	15000	10000	10000
2017-2018	STAGE - II	2017-08-12 00:00:00	KAMAL	20000	10000	10000
2017-2018	STAGE - III	2017-08-12 00:00:00	KAMAL	25000	10000	10000
\.
...
COPY securityoutpass (outpassid, academicyear, batch, branchcode, currentdate, loginuser, nooftimesmonth, nooftimesoverall, reason, registerno, semester, timeout, typeofperson) FROM stdin;
\.
...
COPY securityvisitorpass (visitorid, academicyear, batch, branchcode, currentdate, loginuser, name, noofpersons, persontomeet, reason, semester, staffid, timein, timeout, visitorname, visitortransportmode) FROM stdin;
\.
...
--
-- Data for Name: staffpersonalinformationplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY staffpersonalinformationplayschool (staffid, addressline1, addressline2, age, alternativemobilenumber, area, bloodgroup, course, date_of_join, dateofbirth, designation, emailid, experience, fathersname, logiuser, maritalstatus, mobilenumber, month_year_of_pass, mothersname, no_of_years, percentage, pin, qualification, spousename, staffname, university) FROM stdin;
STA001	S5 II FLOOR VASAN HOMES	WEST BANU NAGAR, PUDHUR, AMBATTUR	40	9283604647	CHENNAI	B+VE	M.E./CSE	2016-12-12 00:00:00	1978-05-06 00:00:00	Teacher	informkamalakannan@gmail.com	SMPT	BAKTHAVATCHALAM	KAMAL	MARRIED	9283604647	APR 2017	MOHANAM	18	75	600053	Post Graduate	RANIPADMINI	KAMALAKANNAN	ANNA UNIVERSITY
STA002	22 II FLOOR VASAN HOMES	THIRUKANDALAM, AMBATTUR	42	9380212493	CHENNAI	B+VE	B.SC/CHEMISTRY	2017-03-12 00:00:00	1976-05-06 00:00:00	Cashier	informkamalakannan@gmail.com	SMPT	MANICKAM	KAMAL	MARRIED	9380212493	APR 2017	CHELLAMAL	18	75	600053	Under Graduate	THENMOZHI	MANIKANDAN	MADRAS UNIVERSITY
STA003	22 II FLOOR VASAN HOMES	THIRUKANDALAM, AMBATTUR	38	9380212493	CHENNAI	B+VE	B.SC/CHEMISTRY	2017-03-12 00:00:00	1980-06-06 00:00:00	Principal	informkamalakannan@gmail.com	SMPT	THIRUMAL	KAMAL	MARRIED	9380212493	APR 2017	CHELLAMAL	18	75	600053	Under Graduate	THENMOZHI	SEETHALAKSHMI	MADRAS UNIVERSITY
\.
...
--
-- Data for Name: studentattendancedetailplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY studentattendancedetailplayschool (id, entrydate, registernumber, status) FROM stdin;
\.
...
--
-- Data for Name: studentattendanceheaderplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY studentattendanceheaderplayschool (acdemicyear, entrydate, program, section, entryday, loginuser, no_of_absent, no_of_present) FROM stdin;
\.
...
COPY studentfood (regno, academic_year, branch, branchcode, foodfees, foodtype, loginuser, semester, student_food_regno) FROM stdin;
\.
...
--
-- Data for Name: studenthomeworkplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY studenthomeworkplayschool (homeworkid, academicyear, entrydate, entryday, homework_content, loginuser, program, section, subjectcategory) FROM stdin;
\.
...
COPY studenthostel (regno, academic_year, amount, branch, branch_code, foodtype, loginuser, optd_facility, semester, student_hostel_regno) FROM stdin;
\.
...
--
-- Data for Name: studentsmonthlyprogressplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY studentsmonthlyprogressplayschool (remarkid, academicyear, category10_rating, category1_rating, category2_rating, category3_rating, category4_rating, category5_rating, category6_rating, category7_rating, category8_rating, category9_rating, entrydate, entryday, loginuser, month, name, program, registernumber, section) FROM stdin;
STUDREM001	2017-2018	10	10	10	5	4	10	8	9	10	4	2017-08-12 00:00:00	FRIDAY	KAMAL	NOVEMBER	AKILESH	TODDLER PROGRAM	TOD101	SECTION - A
STUDREM002	2017-2018	10	10	10	10	10	10	8	9	10	10	2017-08-12 00:00:00	FRIDAY	KAMAL	NOVEMBER	SURESH	TODDLER PROGRAM	TOD102	SECTION - A
STUDREM003	2017-2018	10	10	5	5	8	9	9	9	7	6	2017-08-12 00:00:00	FRIDAY	KAMAL	NOVEMBER	SURESHRAJ	TODDLER PROGRAM	TOD103	SECTION - A
\.
...
--
-- Data for Name: transportchangeplayschool; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY transportchangeplayschool (transportchangeid, academicyear, entrydate, loginuser, name, program, registernumber, remarks, section, stage, transport_init_fees, transport_required, transport_term1_fees, transport_term2_fees, transport_total_fees) FROM stdin;
\.
...
TOD101	2017-2018	1010 Civil Engineering	NIL	AKILESH	103	N	TOD101	3	123	123	STUD
\.
...
--
-- Name: admissionplayschool admissionplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY admissionplayschool
    ADD CONSTRAINT admissionplayschool_pkey PRIMARY KEY (applno);
...
--
-- Name: applicationsaleplayschool applicationsaleplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY applicationsaleplayschool
    ADD CONSTRAINT applicationsaleplayschool_pkey PRIMARY KEY (applno);


--
-- Name: applicationsales applicationsales_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY applicationsales
    ADD CONSTRAINT applicationsales_pkey PRIMARY KEY (applno);
...
--
-- Name: childspickupplayschool childspickupplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY childspickupplayschool
    ADD CONSTRAINT childspickupplayschool_pkey PRIMARY KEY (pickupid);
...
--
-- Name: emergencymessageplayschool emergencymessageplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY emergencymessageplayschool
    ADD CONSTRAINT emergencymessageplayschool_pkey PRIMARY KEY (emergencymessageid);
...
--
-- Name: eventscircularsplayschool eventscircularsplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY eventscircularsplayschool
    ADD CONSTRAINT eventscircularsplayschool_pkey PRIMARY KEY (eventid);
...
--
-- Name: feespaymentplayschool feespaymentplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feespaymentplayschool
    ADD CONSTRAINT feespaymentplayschool_pkey PRIMARY KEY (billno);
...
--
-- Name: firsttable firsttable_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY firsttable
...
--
-- Name: playschoolbalancefeestable playschoolbalancefeestable_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolbalancefeestable
    ADD CONSTRAINT playschoolbalancefeestable_pkey PRIMARY KEY (registernumber);


--
-- Name: playschoolfeesentrybase playschoolfeesentrybase_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolfeesentrybase
    ADD CONSTRAINT playschoolfeesentrybase_pkey PRIMARY KEY (registernumber);


--
-- Name: playschoolschoolfeessetting playschoolschoolfeessetting_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolschoolfeessetting
    ADD CONSTRAINT playschoolschoolfeessetting_pkey PRIMARY KEY (academicyear, program);


--
-- Name: playschoolstudentbaseinformation playschoolstudentbaseinformation_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolstudentbaseinformation
    ADD CONSTRAINT playschoolstudentbaseinformation_pkey PRIMARY KEY (registernumber);


--
-- Name: playschoolstudentpersonalinformation playschoolstudentpersonalinformation_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolstudentpersonalinformation
    ADD CONSTRAINT playschoolstudentpersonalinformation_pkey PRIMARY KEY (registernumber);


--
-- Name: playschooltransportsetting playschooltransportsetting_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschooltransportsetting
    ADD CONSTRAINT playschooltransportsetting_pkey PRIMARY KEY (academicyear, stage);
...
--
-- Name: staffpersonalinformationplayschool staffpersonalinformationplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY staffpersonalinformationplayschool
    ADD CONSTRAINT staffpersonalinformationplayschool_pkey PRIMARY KEY (staffid);
...
--
-- Name: studentattendancedetailplayschool studentattendancedetailplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentattendancedetailplayschool
    ADD CONSTRAINT studentattendancedetailplayschool_pkey PRIMARY KEY (id);
...
--
-- Name: studentattendanceheaderplayschool studentattendanceheaderplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentattendanceheaderplayschool
    ADD CONSTRAINT studentattendanceheaderplayschool_pkey PRIMARY KEY (acdemicyear, entrydate, program, section);
...
--
-- Name: studenthomeworkplayschool studenthomeworkplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studenthomeworkplayschool
    ADD CONSTRAINT studenthomeworkplayschool_pkey PRIMARY KEY (homeworkid);
...
--
-- Name: studentsmonthlyprogressplayschool studentsmonthlyprogressplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentsmonthlyprogressplayschool
    ADD CONSTRAINT studentsmonthlyprogressplayschool_pkey PRIMARY KEY (remarkid);
...
--
-- Name: transportchangeplayschool transportchangeplayschool_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transportchangeplayschool
    ADD CONSTRAINT transportchangeplayschool_pkey PRIMARY KEY (transportchangeid);
...
--
-- Name: admissionplayschool uk_fv1t039lt160ijgt5lrigic8g; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY admissionplayschool
    ADD CONSTRAINT uk_fv1t039lt160ijgt5lrigic8g UNIQUE (registernumber);
...
--
-- Name: childspickupplayschool fk4mx6snohgdmwowx62wsjl5a27; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY childspickupplayschool
    ADD CONSTRAINT fk4mx6snohgdmwowx62wsjl5a27 FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);
...
--
-- Name: admissionplayschool fk5v59kpc4ougnlgq14rpm33hyp; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY admissionplayschool
    ADD CONSTRAINT fk5v59kpc4ougnlgq14rpm33hyp FOREIGN KEY (couns_applno) REFERENCES applicationsaleplayschool(applno);


--
-- Name: emergencymessageplayschool fk62860pmb9a1o1kropx9ev7ghm; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY emergencymessageplayschool
    ADD CONSTRAINT fk62860pmb9a1o1kropx9ev7ghm FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);
...
--
-- Name: studentattendancedetailplayschool fk6nmh9r1w1f6xi99w2isywj1ot; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentattendancedetailplayschool
    ADD CONSTRAINT fk6nmh9r1w1f6xi99w2isywj1ot FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);


--
-- Name: playschoolfeesentrybase fk6uhb3lmptyr1xj9aejf05wi3; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolfeesentrybase
    ADD CONSTRAINT fk6uhb3lmptyr1xj9aejf05wi3 FOREIGN KEY (student_base_registernumber) REFERENCES playschoolstudentpersonalinformation(registernumber);
...
--
-- Name: playschoolstudentbaseinformation fk7rt346e925vvmgcpnifjmuipm; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolstudentbaseinformation
    ADD CONSTRAINT fk7rt346e925vvmgcpnifjmuipm FOREIGN KEY (student_base_registernumber) REFERENCES playschoolstudentpersonalinformation(registernumber);


--
-- Name: playschoolbalancefeestable fk80559d3lcbk09ee586c2qf7mg; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY playschoolbalancefeestable
    ADD CONSTRAINT fk80559d3lcbk09ee586c2qf7mg FOREIGN KEY (student_base_registernumber) REFERENCES playschoolstudentpersonalinformation(registernumber);
...
--
-- Name: studenthostel fk9vak8mbwiitmghei70fl3h6tc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studenthostel
    ADD CONSTRAINT fk9vak8mbwiitmghei70fl3h6tc FOREIGN KEY (student_hostel_regno) REFERENCES studentpersonalinformation(regno);
...
--
-- Name: studentsmonthlyprogressplayschool fkg3h450movei6l8iwsoa507xek; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentsmonthlyprogressplayschool
    ADD CONSTRAINT fkg3h450movei6l8iwsoa507xek FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);
...
--
-- Name: transportchangeplayschool fkp8b1xl5fva0cnhm98kkm1dt84; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transportchangeplayschool
    ADD CONSTRAINT fkp8b1xl5fva0cnhm98kkm1dt84 FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);
...
--
-- Name: studentfood fkrpktn9h5nko6l2ksvdr5922y6; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY studentfood
    ADD CONSTRAINT fkrpktn9h5nko6l2ksvdr5922y6 FOREIGN KEY (student_food_regno) REFERENCES studentpersonalinformation(regno);
...
--
-- Name: feespaymentplayschool fkshft8f2v8fw073tg5g69t53ye; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY feespaymentplayschool
    ADD CONSTRAINT fkshft8f2v8fw073tg5g69t53ye FOREIGN KEY (registernumber) REFERENCES playschoolstudentbaseinformation(registernumber);
