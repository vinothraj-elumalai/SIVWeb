...
COPY institutedetails (instituteid, instituteaddress1, instituteaddress2, institutearea, institutecode, institutecontactno1, institutecontactno2, instituteemail1, instituteemail2, instituteimage, institutelogo, institutename, institutepincode, institutetype, instituteweb, institutestate) FROM stdin;
101	S5 WEST BANU NAGAR	PUDHUR, AMBATTUR	\N	309	9283604647	7200976486	informkamalakannan@gmail.com	informkamalakannan@gmail.com	\N	\N	GB CORP ENGG COLLEGE	600053	ENGINEERING COLLEGE	www.gbcorp.in	TAMILNADU
102	S5 WEST BANU NAGAR	PUDHUR, AMBATTUR	\N	310	9283604647	7200976486	informkamalakannan@gmail.com	informkamalakannan@gmail.com	\N	\N	SBK ENGG COLLEGE	600053	ENGINEERING COLLEGE	www.gbcorp.in	TAMILNADU
\.
...
COPY staffbaseinformation (staffid, branch, branchcode, dateofjoin, designation, loginuser, staffname, staff_base_staffid, status) FROM stdin;
\.
...
COPY studentattendancedetail (regno, entrydate, hour, status) FROM stdin;
\.
...
COPY users (id, academic_year, branch_code, designation, first_name, last_name, password, semester, staff_id, student_id, user_role, username) FROM stdin;
1	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	kamal	4	123	123	MGMT	kamal
2	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	seetha	4	123	123	PRPL	seetha
3	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	rani	4	123	123	OADMSN	rani
4	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	vinoth	4	123	123	FEES	vinoth
5	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	mani	4	123	123	OSUPDT	mani
6	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	vishal	4	123	123	OSTN	vishal
7	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	harshitha	4	123	123	OSTO	harshitha
8	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	akilesh	4	123	123	OTRAN	akilesh
9	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	thirumal	4	123	123	TSTAFF	thirumal
10	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	jagan	4	123	123	HOD	jagan
11	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	suresh	4	123	123	PLO	suresh
12	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	ramesh	4	123	123	SPRT	ramesh
13	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	rajesh	4	123	123	LIB	rajesh
14	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	gojan	4	123	123	HOS	gojan
15	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	valan	4	123	123	STUD	valan
16	2017-2018	1010 Civil Engineering	LECTURER	KAMALAKANNAN	S B	viki	4	123	123	SYSADM	viki
17	2017-2018	1020 Mechanical Engineering	LECTURER	kamalakananna	s b	12MECHI01	4	123	123	STUD	12MECHI01
\.
...
ALTER TABLE ONLY studentattendancedetail
    ADD CONSTRAINT studentattendancedetail_pkey PRIMARY KEY (regno);
