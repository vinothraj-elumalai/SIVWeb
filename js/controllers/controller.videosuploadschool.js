sivwebapp.controller('videosUploadSchoolCtrl', function($scope, $http, hosturl, constantService, Auth) {
    $scope.userdata = Auth.isLoggedIn();
    $scope.videosuploadPlaySchoolData = {};
    $scope.videosuploadPlaySchoolData.instituteid = $scope.userdata.instituteid;
    $scope.videosuploadPlaySchoolData.loginuser = $scope.userdata.username;
         ...
         if(len>10){
            ...
            for(var i=0; i<len; i++){
                ...
                var data = new FormData();
                 ...
                 data.append("program", $scope.videosuploadPlaySchoolData.program);
                 data.append("section", $scope.videosuploadPlaySchoolData.section);
                 data.append("academicyear", $scope.videosuploadPlaySchoolData.academicyear);
                 data.append("instituteid", $scope.videosuploadPlaySchoolData.instituteid);
                 data.append("imagetitle", $scope.videosuploadPlaySchoolData.imagetitle);
                ...
                $('body').append('<span class="overlay overlay'+i+'"></span>');
                 $.ajax({
                    ...
                    error: function (e) {
                        ...
                        alert("Video"+data+" failed to upload! Please try again");
